  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        luxury: "bg-primary text-primary-foreground border border-primary tracking-widest uppercase hover:bg-transparent hover:text-primary font-medium",
        luxuryOutline: "bg-transparent text-foreground border border-foreground/30 tracking-widest uppercase hover:border-primary hover:text-primary font-medium",
        luxuryGhost: "bg-transparent text-foreground tracking-widest uppercase hover:text-primary font-medium",
      },
      size: {
